...
| `references/qa.md` | 188 question/answer pairs covering orientation, star commands, handoffs/forks, graph and memory, rules and domains, project scoping, ingestion, GraphRAG, AST navigation, hooks, relay, admin surfaces, known bugs, and destructive operations. Every pair carries a provenance tag |
